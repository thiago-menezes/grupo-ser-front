...
import {
  ...
  formatPrice,
} from '@/bff/handlers/courses/aggregator';
import { createCoursesApiClient } from '@/bff/services/courses-api';
import type { CourseAPIRaw } from '@/bff/services/courses-api/types';
import type {
